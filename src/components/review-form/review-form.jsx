...
const ReviewForm = (props) => {
  ...
  return ( // ? evt
    <form onSubmit={(evt) => onFormSubmit(evt)} action="#" className="add-review__form">
      ...
      <div className="add-review__text">
        <textarea onChange={(evt) => onTextChange(evt)} value={reviewText} className="add-review__textarea" name="review-text" id="review-text" placeholder="Review text"></textarea>
